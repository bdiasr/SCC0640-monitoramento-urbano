...
FROM
(SELECT Onibus, Latitude, Longitude, ABS(10000*EXTRACT(Hour FROM Hora)+100*EXTRACT(MINUTE FROM hora)+EXTRACT(SECOND FROM hora)-(10000*EXTRACT(Hour FROM SYSTIMESTAMP)+100*EXTRACT(MINUTE FROM SYSTIMESTAMP)+EXTRACT(SECOND FROM SYSTIMESTAMP))) AS AGR_MINUS_PADRAO
FROM HORARIO_PADRAO) HP
JOIN                        
(SELECT Onibus, Latitude, Longitude, ABS((10000*EXTRACT(Hour FROM DataHora)+100*EXTRACT(MINUTE FROM Datahora)+EXTRACT(SECOND FROM Datahora))-(10000*EXTRACT(Hour FROM SYSTIMESTAMP)+100*EXTRACT(MINUTE FROM SYSTIMESTAMP)+EXTRACT(SECOND FROM SYSTIMESTAMP))) AS AGR_MINUS_LOCAL 
FROM LOCALIZACAO) LC
...
ORDER BY ((10000*EXTRACT(Hour FROM L.DataHora)+100*EXTRACT(MINUTE FROM L.DataHora)+EXTRACT(SECOND FROM L.DataHora))-(10000*EXTRACT(Hour FROM SYSTIMESTAMP)+100*EXTRACT(MINUTE FROM SYSTIMESTAMP)+EXTRACT(SECOND FROM SYSTIMESTAMP))), ((10000*EXTRACT(Hour FROM M.PontoEntrada)+100*EXTRACT(MINUTE FROM M.PontoEntrada)+EXTRACT(SECOND FROM M.PontoEntrada))-(10000*EXTRACT(Hour FROM SYSTIMESTAMP)+100*EXTRACT(MINUTE FROM SYSTIMESTAMP)+EXTRACT(SECOND FROM SYSTIMESTAMP))), ((10000*EXTRACT(Hour FROM C.PontoEntrada)+100*EXTRACT(MINUTE FROM C.PontoEntrada)+EXTRACT(SECOND FROM C.PontoEntrada))-(10000*EXTRACT(Hour FROM SYSTIMESTAMP)+100*EXTRACT(MINUTE FROM SYSTIMESTAMP)+EXTRACT(SECOND FROM SYSTIMESTAMP)))
